    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-500 to-purple-500 p-6 text-white">
                ...
                <p className="mt-2 text-sm text-violet-200">This team is responsible for product development and design. Does some other shit too</p>
                <div className='flex items-center gap-3 mb-4'>
                    <span className='text-2xl'> <FaPersonHarassing /> </span>
                    <div>
                ...
                <div className="flex items-center gap-4 text-sm">
                    <div className="flex items-center gap-1">
                        ...
                        <MdOutlinePersonalVideo /><span className="pr-2">1 sub team</span>
                    </div>
                </div>
            </div>
            <SubTeams />
